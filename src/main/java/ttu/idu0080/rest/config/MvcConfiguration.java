...
public class MvcConfiguration extends WebMvcConfigurerAdapter{
    ...
    private static final String PROPERTY_NAME_DATABASE_URL = "jdbc:postgresql:klaht_veebiteenused";
    private static final String PROPERTY_NAME_DATABASE_USERNAME = "kairitlah";
